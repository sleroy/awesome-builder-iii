        ...
        <div class="p-6 space-y-4 sm:p-8 md:space-y-6">
          ...
          <form class="space-y-4 md:space-y-6" action="#" @submit.prevent="login">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-start">
                <div class="flex items-center h-5">
                  <input id="remember" aria-describedby="remember" v-model="rememberme" type="checkbox"
              ...
              <a href="#" class="text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">Forgot
                password?</a>
            </div>
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              ...
              <a href="#" class="font-medium text-primary-600 dark:text-primary-500 hover:underline">Sign up
                <svg aria-hidden="true" class="w-7 h-7 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-red-600"
                  viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg" v-if="inProgress">
                  <path
